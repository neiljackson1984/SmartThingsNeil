        ...
        atomicState.alexaJSON.devices.each {it->
            if (it.accountName == device) {
                ...
                try{
                    ...
                    def params = [uri: "https://" + getURLs()."${alexaCountry}".Alexa + "/api/behaviors/preview",
                                  headers: ["Authorization":"Bearer Atza|IwEBIB2RbWUD6BWm8_60ud1aFA7pSMXl2LY8ykOM9blhUOjdkrDd6cimrcdoGmzol9EaHxEktdNzwXhj4qVxC0AfrR8eNlDYya2H2kQUhOtzGvjZurAOsWBZ198GfWJnxu7LYjlkDvSJYlkJ8P--bR7I9LhjqEqV9JKKFVytplNY1mtODcK5CMCBfFUc0Hhmu0qIGME3JdTySw0q5HMdBZeRfRL3AhA8zMdqwcpWU5hJ-25zXThdKb8CVfB8VNN--2ONExb4f5p-LM4EcIBKAQXi9kOXEUzKsbJvlEEjND8qXr0UoyORDnkPSJIgDTprzRw_fCwWfNltDPhR_e3Q3_6luNtBJLGpbdQeYMJL0WZEI4gnTg",
                                            "Referer": "https://" + getURLs()."${alexaCountry}".Amazon + "/spa/index.html",
                                            "Origin": "https://" + getURLs()."${alexaCountry}".Amazon,
                                            "csrf": "${csrf}",
                                            "Connection": "keep-alive",
